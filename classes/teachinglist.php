...
class teachinglist extends \external_api {
    public static function get_teachinglist_parameters() {
    ...
    public static function get_teachinglist_is_allowed_from_ajax() {
        return true;
    }
    
    public static function get_teachinglist($blockteachings, $teacherid) {
        global $DB;
    ...
    public static function get_teachinglist_returns() {
